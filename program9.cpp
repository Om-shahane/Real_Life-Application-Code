...
int main(){
    ...
    cout << "Marks 120 valid : " << validator.validate(120) << "\n" << endl;
    cout <<  "Amount 4500.50 valid : " << validator.validate(4500.50) << "\n" << endl;
    cout << "Name Priya Sharma valid : " << validator.validate(string("Priya Sharma")) << endl;
    cout << "Name Priya 123 valid : " << validator.validate(string("Priya123")) << endl;
}
